...
class UserRepository extends EntityRepository implements UserProviderInterface
{
    ...
    /**
     * Return users with a state of account expired at a date interval, modulo a step
     *
     * @param DateInterval interval
     * @param DateInterval pas
     *
     * @return list of users
     */
    public function getUsersExpiredAt(\DateInterval $interval, \DateInterval $pas, $repeat = false) 
    {
        $qb = $this->createQueryBuilder('a');
        ...
        {
            // get date limit
            $datelimit = $user->getLastPaymentEnded();
            if (null !== $datelimit)
            {
                // loop for repeat
                do {
